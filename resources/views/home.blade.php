...
<section class="py-16 bg-gray-800">
    ...
    <!-- CATEGORÍAS AGRUPADAS CON IMÁGENES -->
    <section id="categorias" class="py-16">
        ...
        <div class="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <!-- Laptops (agrupa oficina y gaming) -->
            <div class="categoria-principal group relative rounded-xl overflow-hidden shadow-2xl hover:shadow-neon transition-all">
                <img src="https://media.officedepot.com/images/f_auto,q_auto,e_sharpen,h_450/products/7089358/7089358" alt="Laptops" class="w-full h-96 object-cover">
                <div class="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-70"></div>
                <div class="absolute bottom-0 p-8 text-white text-center">
                    <i class="fas fa-laptop text-6xl mb-4"></i>
                    <h3 class="text-3xl font-bold">Laptops</h3>
                    <ul class="mt-4 space-y-2">
                        <li><a href="{{ route('categorias.show', 'laptops-oficina') }}" class="hover:text-green-400">Laptops de Oficina</a></li>
                        <li><a href="{{ route('categorias.show', 'laptops-gaming') }}" class="hover:text-green-400">Laptops Gaming</a></li>
                    </ul>
                </div>
            </div>
            ...
            <!-- PCs de Escritorio -->
            <div class="categoria-principal group relative rounded-xl overflow-hidden shadow-2xl hover:shadow-neon transition-all">
                <img src="https://geekawhat.com/wp-content/uploads/2022/11/Feature.jpg" alt="PCs" class="w-full h-96 object-cover">
                <div class="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-70"></div>
                <div class="absolute bottom-0 p-8 text-white text-center">
                    <i class="fas fa-desktop text-6xl mb-4"></i>
                    <h3 class="text-3xl font-bold">PC de Escritorio</h3>
                    <ul class="mt-4 space-y-2">
                        <li><a href="{{ route('categorias.show', 'pcs-oficina') }}" class="hover:text-green-400">PCs de Oficina</a></li>
                        <li><a href="{{ route('categorias.show', 'pcs-gaming') }}" class="hover:text-green-400">PCs Gaming</a></li>
                    </ul>
                </div>
            </div>
            ...
            <!-- Periféricos Gaming -->
            <div class="categoria-principal group relative rounded-xl overflow-hidden shadow-2xl hover:shadow-neon transition-all">
                <img src="https://m.media-amazon.com/images/I/81lWNgidA3L._AC_UF894,1000_QL80_.jpg" alt="Periféricos" class="w-full h-96 object-cover">
                <div class="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-70"></div>
                <div class="absolute bottom-0 p-8 text-white text-center">
                    <i class="fas fa-gamepad text-6xl mb-4"></i>
                    <h3 class="text-3xl font-bold">Periféricos Gaming</h3>
                    <ul class="mt-4 space-y-2">
                        <li><a href="{{ route('categorias.show', 'teclados-gaming') }}" class="hover:text-green-400">Teclados</a></li>
                        <li><a href="{{ route('categorias.show', 'mouse-gaming') }}" class="hover:text-green-400">Mouse</a></li>
                        <li><a href="{{ route('categorias.show', 'audifonos-gaming') }}" class="hover:text-green-400">Audífonos</a></li>
                    </ul>
                </div>
            </div>
            ...
            <!-- Accesorios -->
            <div class="categoria-principal group relative rounded-xl overflow-hidden shadow-2xl hover:shadow-neon transition-all">
                <img src="https://cdn.thewirecutter.com/wp-content/media/2023/10/laptopstands-2048px-8263.jpg" alt="Accesorios" class="w-full h-96 object-cover">
                <div class="absolute inset-0 bg-gradient-to-t from-black to-transparent opacity-70"></div>
                <div class="absolute bottom-0 p-8 text-white text-center">
                    <i class="fas fa-plug text-6xl mb-4"></i>
                    <h3 class="text-3xl font-bold">Accesorios</h3>
                    <ul class="mt-4 space-y-2">
                        <li><a href="{{ route('categorias.show', 'cables') }}" class="hover:text-green-400">Cables</a></li>
                        <li><a href="{{ route('categorias.show', 'adaptadores') }}" class="hover:text-green-400">Adaptadores</a></li>
                        <li><a href="{{ route('categorias.show', 'mochilas') }}" class="hover:text-green-400">Mochilas</a></li>
                        <li><a href="{{ route('categorias.show', 'soportes') }}" class="hover:text-green-400">Soportes</a></li>
                    </ul>
                </div>
            </div>
        </div>
