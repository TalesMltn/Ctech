<div class="bg-gray-800 rounded-xl shadow-2xl p-8">
    <div class="space-y-8">
        @foreach($cart as $id => $item)
            <div class="flex items-start bg-gray-900 rounded-lg p-6 transition hover:bg-blue-900/40">
                <!-- Imagen -->
                @if($item['image'] ?? false)
                ...
                <div class="flex-1">
                    ...
                    <div class="flex items-center space-x-3 mt-3">
                        <button wire:click.debounce.150ms="decrease({{ $id }})" 
                        ...
                        <button wire:click.debounce.150ms="increase({{ $id }})" 
    ...
    <div class="mt-12 border-t border-gray-700 pt-8">
        ...
        <div class="text-center">
            <a href="{{ route('checkout') }}" class="bg-green-600 hover:bg-green-700 text-white px-12 py-5 rounded-lg font-bold text-2xl transition hover:shadow-neon transform hover:scale-105">
                Proceder al Pago
            </a>
        </div>
    </div>
